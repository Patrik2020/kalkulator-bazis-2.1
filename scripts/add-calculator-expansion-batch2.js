...
function jsonLd(c) {
  ...
  return JSON.stringify({ "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "BreadcrumbList", "@id": `${url}#breadcrumb`, itemListElement: [ { "@type": "ListItem", position: 1, name: "Főoldal", item: "https://kalkulatorbazis.hu/" }, { "@type": "ListItem", position: 2, name: c.categoryTitle, item: `https://kalkulatorbazis.hu/${c.categoryUrl.replace("../", "").replace(/\.html$/, "")}` }, { "@type": "ListItem", position: 3, name: c.title, item: url } ] },
