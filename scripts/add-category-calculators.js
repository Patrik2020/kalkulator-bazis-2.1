...
const calculators = [
  ...
  ["tankolas-kalkulator", "Tankolás kalkulátor", "auto", "Számold ki, hány liter üzemanyagot kapsz a megadott tankolási keretből.", "tankolás üzemanyag liter ár", [["budget","Tankolási keret (Ft)"],["price","Üzemanyagár (Ft/l)"]], "return [['Tankolható mennyiség', (v.budget/v.price).toFixed(1).replace('.', ',')+' l']];"],
