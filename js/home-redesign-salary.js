...
const widget=$('heroSalaryWidget'),input=$('heroSalaryAmount'),inputLabel=$('heroSalaryInputLabel'),resultLabel=$('heroSalaryResultLabel'),result=$('heroSalaryResult'),status=$('heroSalaryApiStatus');
