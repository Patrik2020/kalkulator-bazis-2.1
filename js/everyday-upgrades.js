(() => {
  ...
  article.innerHTML = "<h2>" + method.title + "</h2><p>" + method.body + "</p><h3>Adatkezelés</h3><p>A beírt értékek a böngésződben kerülnek feldolgozásra; a kalkulátor nem menti el őket saját szerverre.</p><p class=\"last-reviewed\">Utolsó módszertani ellenőrzés: <time datetime=\"2026-09-16\">2026. szeptember 16.</time></p>";
